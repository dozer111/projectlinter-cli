...
func (s *makefileSet) Run() *rules.RuleTree {
	...
	return rules.NewRuleTree(
		// https://your_github.com/projects/your_php_library_template/browse/Makefile
		leaf(
			r.fileExists,
			leaf(
				r.fileIsLatest,
				// https://your_github.com/projects/your_php_library_template/pull-requests/12/overview
...
func (s *makefileSet) configureRules() makefileRules {
	const linkOnSource = "https://your_github.com/projects/your_php_library_template/browse/Makefile"
